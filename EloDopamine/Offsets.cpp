...
// int Offsets::HeroInterface = 0x188FE14;

// int Offsets::ObjectIndex = 0x8;
// int Offsets::ObjectTeam = 0x34;
// int Offsets::ObjectMaxHealth = 0xE84;
// int Offsets::ObjectHealth = 0xE74;
// int Offsets::ObjectAttackRange = 0x139C;
// int Offsets::ObjectTargetable = 0xD04;
// int Offsets::ObjectName = 0x2D9C;
...
//== MINIMAP STRUCTURE ==//
int	Offsets::MinimapObject = 0x312611C; //8B 1D ? ? ? ? 85 DB 74 19 //74 22 8B 0D ? ? ? ? 85 C9 74 18 80 79 38 00
int	Offsets::MinimapObjectHud = 0x138;  //C7 44 24 ? ? ? ? ? E8 ? ? ? ? 8B B7 ? ? ? ? 8B //Tomar primer valor ejemplo [esp+120h+var_D4]
int	Offsets::MinimapHudPos = 0x3C;
int	Offsets::MinimapHudSize = 0x44;
//== CHAT STRUCTURE ==//
int	Offsets::Chat = 0x312D968; //8B 0D ? ? ? ? 8A D8 85 // 8B 0D ? ? ? ? 8A D8 85 C9 //8B 0D ? ? ? ? 83 78 44 00
...
int	Offsets::OMissileDestIdx     = 0x318; // - At first Position //0x330
int	Offsets::OMissileStartPos    = 0x02DC;
int	Offsets::OMissileEndPos      = 0x02E8;
...
int	Offsets::AIManager                      = 0x2E74; //LPLAYER->VTABLE 149 MOV
...
///Unused////
// int	Offsets::ObjExperience          = 0x3574;
// int	Offsets::ObjLevel               = ObjExperience + 0x10;
// int	Offsets::ObjAVAIABLESpellPOINTS = 0x33CC;
// int	Offsets::ObjSUMMONERSpell_D     = 0x3858;
// int	Offsets::ObjSUMMONERSpell_F     = 0x3864;
// int	Offsets::ObjKEYSTONE            = 0x3878;